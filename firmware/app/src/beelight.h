...
*/
#define ZB_ENV_SENSOR_OUT_CLUSTER_NUM           1

/** @brief Number of attributes.
*/
#define ZB_ENV_SENSOR_REPORT_ATTR_COUNT         (ZB_ZCL_ILLUMINANCE_MEASUREMENT_REPORT_ATTR_COUNT + 7)

/** @brief Continuous value change attribute count.
*/
#define ZB_ENV_SENSOR_CVC_ATTR_COUNT            1
